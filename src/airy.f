...
c        READ(*,*)X
c        CALL AIRYA(X,AI,BI,AD,BD)
c        WRITE(*,30)
c        WRITE(*,40)
c        WRITE(*,10)X,AI,BI,AD,BD
c        WRITE(*,*)
c        CALL AIRYA(-X,AI,BI,AD,BD)
c        WRITE(*,50)
c        WRITE(*,40)
c        WRITE(*,20)X,AI,BI,AD,BD
c10      FORMAT(1X,F5.1,4D16.8)
c20      FORMAT(1X,F5.1,4D16.8)
c30      FORMAT(4X,'x',8X,'Ai(x)',11X,'Bi(x)',11X,'Ai''(x)',
c     &         10X,'Bi''(x)')
c40      FORMAT(2X,'----------------------------------',
c     &        '-----------------------------------')
c50      FORMAT(4X,'x',8X,'Ai(-x)',10X,'Bi(-x)',10X,
c     &        'Ai''(-x)',9X,'Bi''(-x)')
c        END
